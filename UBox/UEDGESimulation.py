...
def GenerateTag(Sim=None):
    ...
    if Settings.CurrentProject is None:
        raise ValueError("No current project currently defined. Use SetCurrentProject() to define one")
    Tag['InputDir']=Settings.CurrentProject.GetDir('InputDir')
    Tag['RunDir']=Settings.CurrentProject.GetDir('RunDir')
    Tag['SaveDir']=Settings.CurrentProject.GetDir('SaveDir')
    Tag['GridDir']=Settings.CurrentProject.GetDir('GridDir')
